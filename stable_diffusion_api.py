...
end_txt = ", foreground, middle ground, background, perspective, light, color, texture, detail, beauty, wonder,<lora:gachaSplashLORA_gachaSplashFarShot:0.4>"#,<lora:gachaSplashLORA_gachaSplashFarShot:1>
